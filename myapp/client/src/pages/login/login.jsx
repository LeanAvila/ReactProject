  ...
  return (
      <div>
          ...
          <div className="container-fluid p-3">
            <div className="text-center my-3"><h4>Login</h4> </div>
            ...
            <form onSubmit={this.handleSubmit} >
              ...
              <div className="form-group text-center ">
                <div className="form-check">
                  <input className="form-check-input" type="checkbox" onChange={this.handleChange} name="rememberMe"/>
                  <label className="form-check-label text-center" htmlFor="rememberMe">
                    Remember Me
                  </label>
                </div>
              </div>
            ...
            <div className="container-fluid px-3">
                <div className="row text-center border rounded-pill shadow-sm mb-2">
                    <div className="col">
                        <i class="fab fa-google fa-2x my-3">&nbsp;&nbsp; Log in with Google</i>
                    </div>
                    
                </div>
                <div className="row text-center border rounded-pill shadow-sm">
                    <div className="col">
                        <i class="fab fa-facebook-square fa-2x my-3">&nbsp;&nbsp; Log in with Facebook</i>
                    </div>
                </div>
            </div>
